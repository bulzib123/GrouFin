...
import com.brommko.android.zeroqode.util.AssetsUtils;
import com.brommko.android.zeroqode.util.AsyncServer;
import com.brommko.android.zeroqode.util.IabBroadcastReceiver;
import com.brommko.android.zeroqode.util.IabHelper;
import com.brommko.android.zeroqode.util.IabResult;
import com.brommko.android.zeroqode.util.Inventory;
import com.brommko.android.zeroqode.util.NetworkHandler;
import com.brommko.android.zeroqode.util.PermissionUtil;
import com.brommko.android.zeroqode.util.Pref;
import com.brommko.android.zeroqode.util.ProgressDialogHelper;
import com.brommko.android.zeroqode.util.Purchase;
import com.brommko.android.zeroqode.util.UrlHandler;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DownloadListener, IabBroadcastReceiver.IabBroadcastListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    private String js = "javascript: (function(){setTimeout(function(){Array.from(document.querySelectorAll('a[target=\"_blank\"]')).forEach(link => link.removeAttribute('target'));console.log('remove');}, 5000);})();";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AssetsUtils.copyAssetFolderToFolder(this);
        if (!isServerStarted) {
            isServerStarted = true;
            new AsyncServer(this).execute();
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PermissionUtil.MY_PERMISSIONS_REQUEST_CALL) {
            ...
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                UrlHandler.call(MainActivity.this, urlData);
            }
        } else if (requestCode == PermissionUtil.MY_PERMISSIONS_REQUEST_SMS) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                UrlHandler.sms(MainActivity.this, urlData);
            }
    ...
    private class UriWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            Log.e("Cookies", "shouldOverrideUrlLoading");
        ...
        private void loadError(WebView view) {
            if (!NetworkHandler.isNetworkAvailable(view.getContext())) {
                if (!target_url.equals("http://localhost:8080/")) {
                    view.loadUrl("http://localhost:8080/NoInternet.html");
                }
            }
        }
...
//            mWebviewPop.getSettings().setUserAgentString("my-user-agent");
