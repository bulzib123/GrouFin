...
public class PermissionUtil {
    ...
    public static void requestPermission(Activity mActivity, String permision, int permissionNumber) {
        ...
        ActivityCompat.requestPermissions(mActivity, new String[]{permision}, permissionNumber);
    }
